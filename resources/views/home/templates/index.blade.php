...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('foto/logonya.webp') }}">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-danger ftco_navbar bg-white ftco-navbar-light" id="ftco-navbar"">
        <div class="container">
            <img src="{{ asset('foto/logonya1.webp') }}" href="{{ url('home') }}" width="80">
            ...
            <div class="row py-3">
                ...
                <div class="col-md-3">
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <p style="margin-top: -20px">Dusun Pakaian,
                            Lemari, Indonesia</p>
                        <p>Telepon : </p>
                        <p style="margin-top: -20px">081234567890 (Whatsapp)</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="ftco-footer-widget mb-4">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center mt-3" style="color: #000">
                    <p>Copyright © 2025 Griya Pakaian | All Rights Reserved</p>
                </div>
            </div>
        </div>
    </footer>
    ...
    <a href="https://wa.me/6289676341551" class="whatsapp-icon" target="_blank">
