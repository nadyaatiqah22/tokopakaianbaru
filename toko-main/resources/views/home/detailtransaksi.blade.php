                ...
                <div class="col-md-8">
                    ...
                    <div class="card py-2 px-2 text-justify">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <p style="color: black; font-weight:bold;" class="text-right">Rp
                                    {{ number_format($totalbelanja) }} <br> <span style="color: red; font-weight:400;">NON
                                        REFUNDABLE</span></p>
                            </div>
                        </div>
                        <hr>
                        <p>Dengan melanjutkan ke tahapan selanjutnya, Anda telah membaca dan setuju dengan <a href="#" style="color: #55acce;">Syarat & Kententuannya</a>.</p>

                        <?php if ($datapembelian->statusbeli == "Belum Bayar") { ?>
                        <a class="btn btn-lg text-white" href="{{ url('home/pembayaran/' . $datapembelian->idpembelian) }}"
                            style="background-color: #55acce">Lanjutkan Pembayaran</a>
                        <?php } else { ?>
                        <a class="btn btn-lg text-white" href="{{ url('home/invoice/' . $datapembelian->idpembelian) }}"
                            style="background-color: #55acce">Invoice</a>
                        <?php } ?>
                    </div>
                </div>
                <div class="col-md-4">
